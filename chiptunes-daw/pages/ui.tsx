...
import { ColorPaletteNames, Colors } from '@components/interface/Color';
...
const Home = (): JSX.Element => {
  ...
  return (
    <>
      ...
      <IconButton size="small" color="primary" inverted style={{ zIndex: 9998, position: 'fixed', bottom: 20, right: 20 }} onClick={() => {window.scrollTo(0, 0)}}>
